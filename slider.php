                            ...
                            <div class="col offset-2">
                                <div class="top-bar__inner row justify-content-between align-items-center">
                                    <ul class="top-bar__list list-unstyled col">
                                        <li class="top-bar__item"><a class="top-bar__link" href="mailto:ksachin728195@outlook.com">sachinraj1367@mail.com</a></li>
                  ...
                  <div class="b-seller">
                    <div class="b-seller__header">
                      ...
                      <div class="b-seller__title">
                        <div class="b-seller__name">Sachin kumar paswan</div>
                        <div class="b-seller__category">Member Since January 2020</div>
                      </div>
                    </div>
                    <div class="b-seller__main"><i class="b-seller__ic fas fa-phone text-primary"></i>
                      <div class="b-seller__contact"><span class="d-block">Contact Seller</span><a class="b-seller__phone" href="tel:7014605438">1 (628) 082 3640</a></div>
                ...
                <div class="col-lg-4 col-sm-5">
                  <div class="footer-section footer-section_info">
                    ...
                    <div class="footer-contacts">
                      ...
                      <div class="footer-contacts__item"><i class="ic icon-envelope"></i><a href="mailto:support@domain.com">sachinraj1367@gmail.com</a></div>
                      <div class="footer-contacts__item"><i class="ic icon-earphones-alt"></i>Phone:
                        
                        <a href="tel:+91 6280823640">+1 701 460 5438</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="footer-copyright">
                    Copyrights (c) 20 Revus - Auto Dealer Template. All rights reserved.
